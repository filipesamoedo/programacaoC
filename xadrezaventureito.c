// Jogo de Xadrez para movimentação de Torre, Bispo, Rainha e Cavalo em C - Nível Aventureiro
...
int main (){
    ...
    printf("Neste jogo vamos mover a Torre, o Bispo, a Rainha e o Cavalo.\n");
    ...
    // Movimento do Cavalo com Switch Case Aninhado - TEMA 4 - MODO AVENTUREIRO

    int direcao_cavalo1, direcao_cavalo2;

    printf("Agora vamos movimentar o Cavalo.\n");
    printf("Para isso precisamos escolher as duas direções, já que o movimento é em L.\n");  
    printf("Escolha a primeira direção do Cavalo:\n");
    printf("[1] Norte\n");
    printf("[2] Sul\n");
    printf("[3] Leste\n");
    printf("[4] Oeste\n");
    printf("Digite o número correspondente à direção: ");
    scanf("%d", &direcao_cavalo1);

    switch (direcao_cavalo1) // SWITCH PARA A PRIMEIRA DIREÇÃO
    {
    case 1:
        printf("Agora a segunda direção.\n"); // REQUISIÇÃO DA SEGUNDA DIREÇÃO APÓS [NORTE]
        printf("[1] Leste\n");
        printf("[2] Oeste\n");
        printf("Digite o número correspondente à direção: ");
        scanf("%d", &direcao_cavalo2);

        switch (direcao_cavalo2)
        {
        case 1: // NORTE NORTE LESTE

            printf("O Cavalo se moveu 2x para o Norte e 1x para o Leste.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Norte!\n");
                }
        ...
        case 2: // NORTE NORTE OESTE

            printf("O Cavalo se moveu 2x para o Norte e 1x para o Oeste.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Norte!\n");
                }
        ...
        break;
        default:
            printf("Direção inválida! Use 1 ou 2.\n");
            printf("Reiniciliaze o programa.\n");
            break;
        }
    break;
    case 2:
        printf("Agora a segunda direção.\n"); // REQUISIÇÃO DA SEGUNDA DIREÇÃO APÓS [SUL]
        printf("[1] Leste\n");
        printf("[2] Oeste\n");
        printf("Digite o número correspondente à direção: ");
        scanf("%d", &direcao_cavalo2);
        ...
        switch (direcao_cavalo2)
        {
        case 1: // SUL SUL LESTE

            printf("O Cavalo se moveu 2x para o Sul e 1x para o Leste.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Sul!\n");
                }
        ...
        case 2: // SUL SUL OESTE

            printf("O Cavalo se moveu 2x para o Sul e 1x para o Oeste.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Sul!\n");
                }
    ...
    break;
    case 3:
        printf("Agora a segunda direção.\n"); // REQUISIÇÃO DA SEGUNDA DIREÇÃO APÓS [LESTE]
        printf("[1] Norte\n");
        printf("[2] Sul\n");
        printf("Digite o número correspondente à direção: ");
        scanf("%d", &direcao_cavalo2);
        ...
        switch (direcao_cavalo2)
        {
        case 1: // LESTE LESTE NORTE

            printf("O Cavalo se moveu 2x para o Leste e 1x para o Norte.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Leste!\n");
                }
        ...
        case 2: // LESTE LESTE SUL

            printf("O Cavalo se moveu 2x para o Leste e 1x para o Sul.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Leste!\n");
                }
    ...
    break;
    case 4:
        printf("Agora a segunda direção.\n"); // REQUISIÇÃO DA SEGUNDA DIREÇÃO APÓS [OESTE]
        printf("[1] Norte\n");
        printf("[2] Sul\n");
        printf("Digite o número correspondente à direção: ");
        scanf("%d", &direcao_cavalo2);
        ...
        switch (direcao_cavalo2)
        {
        case 1: // OESTE OESTE NORTE

            printf("O Cavalo se moveu 2x para o Oeste e 1x para o Norte.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Oeste!\n");
                }
        ...
        case 2: // OESTE OESTE SUL

            printf("O Cavalo se moveu 2x para o Oeste e 1x para o Sul.\n");
            for (int i = 1; i <= 1; i++) {
                for (int j = 1; j <= 2; j++) {
                    printf("Oeste!\n");
                }
        ...
        break;
    default:
        printf("Direção inválida! Use 1, 2, 3 ou 4.\n");
        printf("Reiniciliaze o programa.\n");
        break;
}
    ...
    printf("Parabéns pelas escolhas!\n");
